...
<form action="/register/student" method="POST" enctype="multipart/form-data">
    ...
    <div class="bg-white shadow-lg rounded px-8 pt-6 pb-8 mb-4 flex flex-col mt-4">
        ...
        <div class="mb-4">
            <label class="block text-grey-darker text-sm font-bold mb-2" for="school_years">
            School Years
            </label>
            <input class="shadow border rounded w-full py-2 px-3 text-grey-darker" name="school_years" id="school_years" type="text" placeholder="School Years">
        </div>
        <div class="mb-4">
            <label class="block text-grey-darker text-sm font-bold mb-2" for="major">
            Major
            </label>
            <input class="shadow border rounded w-full py-2 px-3 text-grey-darker" name="major" id="major" type="text" placeholder="Major">
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GH Repos\cis-355-intern-project-lara\resources\views/Auth/student.blade.php ENDPATH**/ ?>