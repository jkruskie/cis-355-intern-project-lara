...
<p class="text-lg text-center font-bold m-5">Create Internship</p>
<div>
    <div class="mt-5 md:mt-0 md:col-span-2">
        <form action="/internships/store" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?> 
                    ...
                    <div class="text-center">
                        <div class="">
                            ...
                            <div class="mb-4 flex rounded-md shadow-sm">
                                <input type="text" name="company_name" id="company_name" class="margin-0-auto text-black p-1">
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                        <div class="">
                            ...
                            <div class="mb-4 flex rounded-md shadow-sm">
                                <input type="text" name="company_location" id="company_location" class="margin-0-auto text-black p-1">
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
                        <div class="">
                            ...
                            <div class="mb-4 flex rounded-md shadow-sm">
                                <input type="text" name="job_type" id="job_type" class="margin-0-auto text-black p-1">
                            </div>
                        </div>
                    </div>
                    <div class="text-center">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GH Repos\cis-355-intern-project-lara\resources\views/Internships/create.blade.php ENDPATH**/ ?>